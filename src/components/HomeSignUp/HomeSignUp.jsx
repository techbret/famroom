                            ...
                            <div className="px-4 sm:px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                                <div>
                                    ...
                                    <p className="mt-3 text-base text-lime-900 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                        Famtree is designed to be like any other social media site, except its JUST FOR FAMILIES! We have designed multiple features that are specifically designed to keep your family up to date on all important information and changes.
                                    </p>
                                    <p className="mt-8 text-base font-semibold text-lime-900 sm:mt-10">Features Include</p>
                                    <div className="mt-5 w-full sm:mx-auto sm:max-w-lg lg:ml-0">
                                        <div className="flex flex-wrap items-start justify-between">
                                            <div className="flex justify-center px-1">
                                                <h1 className="text-2xl font-bold text-lime-900">Family Calander</h1>
                                            </div>
                                            <div className="flex justify-center px-1">
                                                <h1 className="text-2xl font-bold text-lime-900">Chatrooms</h1>
                                            </div>
                                            <div className="flex justify-center px-1">
                                                <h1 className="text-2xl font-bold text-lime-900">Status Logs</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
