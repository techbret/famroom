...
export default function HomeSignUp() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-indigo-100">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="px-4 sm:px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                <div>
                  <h1 className="mt-4 text-4xl font-bold tracking-tight text-indigo-900 sm:text-5xl md:text-6xl">
                    Keep your family connected
                  </h1>
                  <p className="mt-3 text-base text-indigo-900 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                  ...
                  <form action="">
                    ...
                    <button className="ml-4 rounded-md border border-transparent bg-indigo-600 py-3 px-5 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Sign Up</button>
                  </form>

                  <p className="mt-8 text-base font-semibold text-indigo-900 sm:mt-10">
                    Features Include
                  </p>
