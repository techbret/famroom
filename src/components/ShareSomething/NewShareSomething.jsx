...
import { CalendarIcon, PaperClipIcon, TagIcon, UserCircleIcon, VideoCameraIcon, PhotoIcon, CalendarDaysIcon } from '@heroicons/react/20/solid'
            ...
            <div className="absolute inset-x-px bottom-0">
                ...
                <div className="flex flex-nowrap justify-end space-x-2 py-2 px-2 sm:px-3">
                    <Listbox as="div" value={assigned} onChange={setAssigned} className="flex-shrink-0">
                        {({ open }) => (
                            <>
                                <Listbox.Label className="sr-only"> Select Groups </Listbox.Label>
                                        ...
                                        <Listbox.Options className="absolute right-0 z-10 mt-1 max-h-56 w-52 overflow-auto rounded-lg bg-white py-3 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                            ...
                                            >
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-3 block truncate font-medium">All Groups</span>
                                                </div>
