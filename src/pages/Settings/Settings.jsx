...
export default function Settings() {
  ...
  return (
    <div>
      <div as="div" className="relative overflow-hidden bg-zinc-700 pb-32">
                  ...
                  <div className="mt-6 flex flex-col lg:flex-row">
                    <div className="flex-grow space-y-6">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          Brief description of what you have been up to lately.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-shrink-0 lg:flex-grow-0">
                      ...
                      <div className="mt-1 lg:hidden">
                        <div className="flex items-center">
                          <div
                            ...
                            aria-hidden="true"
                          >
                            <img className="h-full w-full rounded-full" src={profileUrl} alt="" />
                          </div>
                      ...
                      <div className="relative hidden overflow-hidden rounded-full lg:block">
                        <img className="relative h-40 w-40 rounded-full" src={profileUrl} alt="" />
                        <label
                      ...
                      <Switch.Group as="li" className="flex items-center justify-between py-4">
                        <div className="flex flex-col">
                          <Switch.Label as="p" className="text-sm font-medium text-gray-900" passive>
                            Available to be searched by Name
                          </Switch.Label>
